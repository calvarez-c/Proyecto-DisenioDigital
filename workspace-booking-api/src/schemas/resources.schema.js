...
const updateResourceSchema = z.object({
    ...
    description: z.string().optional(),
    capacity: z.number().int().positive("Este dato deber ser un número positivo.").optional(),
    price_per_hour: z.number().positive("El precio debe ser un número posivivo.").optional(),
    is_active: z.boolean().optional()
}).strict()

export const vallidateCreateResource = (data) => createResourceSchema.safeParse(data)
